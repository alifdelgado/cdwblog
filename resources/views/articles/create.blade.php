                    ...
                    <form method="post" action="{{ route('articles.store') }}" class="px-8 mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt"
                                class="block w-full h-20 mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"> </textarea>
                            @error('excerpt')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                class="block w-full h-40 mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"> </textarea>
                            @error('description')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
